          ...
          <div>
            <div className="card mt-3 border-0">
              <div className="row">
                ...
                <i
                  className="fa-regular fa-plus col m-2"
            ...
            <div className="card mt-3 border-0">
              <div className="row">
                <div className="col-2">
                  <i
                    style={{background: 'rgb(177, 177, 177)', padding: "11px"}}
                    className="fa-solid fa-car-on rounded"
                  ></i>
                </div>
                ...
                <i
                  className="fa-regular fa-plus col-2 m-2"
                  style={{textAlign: 'end', alignSelf: "center"}}
                ></i>
              </div>
            </div>
              ...
              <div className="row">
                <div className="col-2">
                  <i
                    ...
                    className="fa-solid fa-car-side rounded"
                  ></i>
                </div>
                <div className="col-7" style={{alignSelf: "center"}}>
              ...
              <div className="row">
                <div className="col-2">
                  <i
                    ...
                    className="fa-solid fa-gas-pump rounded"
                  ></i>
                </div>
                <div className="col-7" style={{alignSelf: "center"}}>
            ...
            <div className="card mt-3 border-0">
              <div className="row">
                <div className="col-2">
                  <i
                    style={{background: 'rgb(177, 177, 177)', padding: "11px"}}
                    className="fa-solid fa-map-pin rounded"
                  ></i>
                </div>
                <div className="col-7" style={{alignSelf: "center"}}>
            ...
            <div className="card mt-3 border-0">
              <div className="row">
                <div className="col-2">
                  <i
                    style={{background: 'rgb(177, 177, 177)', padding: "9px"}}
                    className="fa-solid fa-palette rounded"
                  ></i>
                </div>
                <div className="col-7" style={{alignSelf: "center"}}>
            ...
            <div className="card mt-3 border-0">
              <div className="row">
                <div className="col-2">
                  <i
                    style={{background: 'rgb(177, 177, 177)', padding: "9px"}}
                    className="fa-solid fa-gauge-high rounded"
                  ></i>
                </div>
                <div className="col-7">
                ...
                <i
                  className="fa-regular fa-plus col-2 m-1"
                  style={{textAlign: "end", alignSelf: "center"}}
                ></i>
              </div>
            </div>
            <div className="card mt-3 border-0">
              <div className="row">
                <div className="col-2">
                  <i
                    style={{background: 'rgb(177, 177, 177)', padding: "9px"}}
                    className="fa-solid fa-car-burst rounded"
                  ></i>
                </div>
                <div className="col-7" style={{alignSelf: "center"}}>
            ...
            <div className="card mt-3 border-0">
              <div className="row">
                <div className="col-2">
                  <i
                    style={{background: 'rgb(177, 177, 177)', padding: "9px"}}
                    className="fa-solid fa-gears rounded"
                  ></i>
                </div>
                <div className="col-7" style={{alignSelf: "center"}}>
            ...
            <div className="card p-2 mt-2" style={{textAlign: "center"}}>البحث</div>
          </div>
        </aside>  
        </>
    )
